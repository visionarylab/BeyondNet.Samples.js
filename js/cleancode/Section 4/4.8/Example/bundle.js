...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__console_log_handler__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__toastr_handler__ = __webpack_require__(3);




function configureErrorHandler() {
    let errorHandler = new __WEBPACK_IMPORTED_MODULE_0__error_handler__["a" /* ErrorHandler */](new __WEBPACK_IMPORTED_MODULE_2__toastr_handler__["a" /* ToastrHandler */]());
    return errorHandler;
}
...
/* unused harmony export ConsoleLogHandler */
...
class ToastrHandler {
    handle(title, body) {
        __WEBPACK_IMPORTED_MODULE_0_toastr__["error"](`${title} - ${body}`);
    }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = ToastrHandler;
