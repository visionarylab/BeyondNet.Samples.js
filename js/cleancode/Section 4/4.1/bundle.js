...
let http = new __WEBPACK_IMPORTED_MODULE_0__http_client__["a" /* HttpClient */]();
    ...
    get(url) {
        return fetch(url, {
            ...
            if(response.ok) {
                ...
                __WEBPACK_IMPORTED_MODULE_0__error_handler__["a" /* ErrorHandler */].handle(response);
            }
        })
    }
}
...
class ErrorHandler {
    static handle(response) {
        if(response.status == 401) {
            __WEBPACK_IMPORTED_MODULE_0_toastr__["error"]("You are not authorized to view this content");
        }
        else if (response.status == 404) {
            __WEBPACK_IMPORTED_MODULE_0_toastr__["warning"]("Content not found");
        }
        else if(response.status == 500) {
            __WEBPACK_IMPORTED_MODULE_0_toastr__["error"]("Internal server error");
        }
        else {
            __WEBPACK_IMPORTED_MODULE_0_toastr__["info"]("Unknown error");
        }
    }
}
